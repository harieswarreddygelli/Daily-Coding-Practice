...
# Validate dimensions for matrix subtraction
if r1 != r2 or c1 != c2:
    print("Error: Matrix subtraction is not possible. Both matrices must have the same dimensions.")
else:
    matrix1 = []
    ...
    print("=" * 10, "The result matrix (Subtraction)", "=" * 10)
    result = []
    for i in range(r1):
        res = []
        for j in range(c1):
